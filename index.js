...
app.delete("/borrarAnimal", function (req, res) {
  ...
  app.post("/catlover",function(req,res){
    const catlover=req.body;
       db.collection("catlover").updateOne(catlover,function(err,datos){
           if(err!==null){
               res.send(err);
           }else{
               res.send(datos);
  ...
  app.get("/catlover",function(req,res){
    db.collection("catlover").find().toArray(function(err,datos){
        if (err!==null){
            res.send(err);
        }else{
            res.send(datos);
...
app.post("/doglover",function(req,res){
    const catlover=req.body;
       db.collection("doglover").insertOne(catlover,function(err,datos){
           if(err!==null){
               res.send(err);
           }else{
               res.send(datos);
   ...
   app.get("/doglover",function(req,res){
    db.collection("doglover").find().toArray(function(err,datos){
        if (err!==null){
            res.send(err);
        }else{
            res.send(datos);
